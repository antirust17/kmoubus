window.onload = function() {
	kmoubusMain();
	kmoubusLoadHTML("kmoubus-header",'http://archisum.net/kmoubus/kmoubus-header.html');
	//kmoubusLoadHTML("kmoubus-mobile-header",'kmoubus-mobile-header.html');
	//kmoubusLoadHTML("kmoubus-table",'kmoubus-table.html');
